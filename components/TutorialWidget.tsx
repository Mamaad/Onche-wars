...
export const TutorialWidget = ({ user }: { user: User }) => {
            ...
            <TechCard className={`p-0 border-tech-blue/50 transition-all ${isOpen ? '' : 'h-12 overflow-hidden'}`}>
                ...
                >
                    <div className="flex items-center gap-2">
                        <LucideCircle className="text-tech-blue animate-pulse" size={16}/>
                ...
                {isOpen && (
                    <div className="p-4 bg-black/80">
                        ...
                        <div className="bg-slate-800/50 p-2 rounded flex items-center gap-2 text-xs text-green-400 font-mono border border-slate-700">
                            <LucideGift size={14}/>
                            Récompense: 
                            {activeQuest.reward.risitasium && ` ${activeQuest.reward.risitasium} Metal`}
                            {activeQuest.reward.stickers && ` ${activeQuest.reward.stickers} Cristal`}
